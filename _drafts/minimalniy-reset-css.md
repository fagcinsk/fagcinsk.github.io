...
layout: post
categories: frontend
title: Минимальный скрипт сброса стилей reset.css
...
Позже нашёл простое современное решение - минималистичный и в то же время более полноценный скрипт сброса стилей [minireset.css](https://github.com/jgthms/minireset.css)
